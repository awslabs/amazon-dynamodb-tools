"""
Configuration management for DynamoDB Optima platform.
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="DynamoDB Optima", description="Application name")
    ...
    organizations_role_session_name: str = Field(
        default="dynamodb-optima",
        description="Role session name for STS AssumeRole"
    )
