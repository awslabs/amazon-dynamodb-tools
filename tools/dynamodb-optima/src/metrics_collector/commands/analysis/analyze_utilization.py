...
def analyze_utilization(ctx, days, table, threshold, min_savings, format):
    ...
    Examples:
        ...
        metrics-collector analyze-utilization --days 30
        
        # Analyze specific table
        metrics-collector analyze-utilization --table us-east-1:my-table
        
        # Show only recommendations with >$50 savings
        metrics-collector analyze-utilization --min-savings 50
        
        # Use 30% utilization threshold
        metrics-collector analyze-utilization --threshold 30
    """
    try:
