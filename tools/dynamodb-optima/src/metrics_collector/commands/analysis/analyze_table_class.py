...
def analyze_table_class(
    ...
    Examples:
        ...
        metrics-collector analyze-table-class --region us-east-1 --table MyTable
        
        # Analyze with higher savings threshold
        metrics-collector analyze-table-class --min-savings 100 --months 6
        
        # Output as JSON
        metrics-collector analyze-table-class --format json
    """
    try:
