"""
Main Streamlit application for metrics-collector GUI.
...
from metrics_collector.database.connection import get_connection
from metrics_collector.gui.models import RecommendationFilter
from metrics_collector.gui.database import get_available_regions, get_available_tables, get_available_accounts
...
def main():
    ...
    if selected_page == "Dashboard":
        from metrics_collector.gui.page_modules.dashboard import render_dashboard

        render_dashboard(connection, filters)
    elif selected_page == "Capacity Mode Analysis":
        from metrics_collector.gui.page_modules.capacity_analysis import render_capacity_analysis

        render_capacity_analysis(connection, filters)
    elif selected_page == "Table Class Analysis":
        from metrics_collector.gui.page_modules.table_class_analysis import render_table_class_analysis

        render_table_class_analysis(connection, filters)
    elif selected_page == "Utilization Analysis":
        from metrics_collector.gui.page_modules.utilization_analysis import render_utilization_analysis
