...
from python_modules.load_export.utils.enums import Operation
...
class TestBatchWriterThrottleSilentFailure:
    ...
    @patch('python_modules.load_export.writers.batch_writer.get_error_message', side_effect=_real_get_error_message)
    @patch('python_modules.load_export.writers.batch_writer.get_error_code', side_effect=_real_get_error_code)
    @patch('python_modules.load_export.writers.batch_writer.RateLimiterWorker')
