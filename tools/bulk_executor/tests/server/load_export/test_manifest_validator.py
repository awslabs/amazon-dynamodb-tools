...
from python_modules.load_export.validators.manifest_validator import ManifestValidator
...
{"itemCount":50,"md5Checksum":"def456==","etag":"etag2","dataFileS3Key":"data/file2.json.gz"}'''
        ...
        with patch('python_modules.load_export.validators.manifest_validator.MD5Validator') as mock_md5_class:
