...
def collect_cur(
    ...
    Prerequisites:
        - Run 'metrics-collector discover' first to find CUR location
    ...
    Examples:
        ...
        metrics-collector collect-cur --months 6 --force
        
        # Use specific AWS profile
        metrics-collector collect-cur --profile production
    """
    ...
    try:
        ...
        if not cur_metadata:
            ...
            click.echo()
            click.echo("Please run 'metrics-collector discover' first to find CUR location")
        ...
        click.echo("   1. Run 'metrics-collector analyze-table-class' to generate recommendations")
        click.echo("   2. Run 'metrics-collector health' to verify system status")
