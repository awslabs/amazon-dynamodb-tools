...
def analyze_capacity(ctx, days, table, min_savings, format):
    ...
    Examples:
        ...
        metrics-collector analyze-capacity --days 30
        
        # Analyze specific table
        metrics-collector analyze-capacity --table 123456:us-east-1:my-table
        
        # Show only recommendations with >$100 savings
        metrics-collector analyze-capacity --min-savings 100
    """
    try:
