...
- [Metrics Collector](metrics-collector/README.md) - This tool captures Amazon DynamoDB table metris in your account for all the regions. Use this script to identify which tables are over-provisioned.
